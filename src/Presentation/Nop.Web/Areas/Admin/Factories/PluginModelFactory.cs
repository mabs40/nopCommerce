...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class PluginModelFactory : IPluginModelFactory
    {
        ...
        public virtual PluginListModel PreparePluginListModel(PluginSearchModel searchModel)
        {
            ...
            var friendlyName = string.IsNullOrEmpty(searchModel.SearchFriendlyName) || searchModel.SearchFriendlyName.Equals("0") ? null : searchModel.SearchFriendlyName;
            var author = string.IsNullOrEmpty(searchModel.SearchAuthor) || searchModel.SearchAuthor.Equals("0") ? null : searchModel.SearchAuthor;
